...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit']))
{
	...
	$dept =checkempty($_POST['dept2']);
	$course =checkempty($_POST['course2']);
	$level =checkempty($_POST['level']);
	
	$dept1 =$_POST['dept2'];
	$course1 =$_POST['course2'];
	$level1 =$_POST['level'];
	
	if(($dept != FALSE)&& ($course != FALSE)&& ($level != FALSE)&& ($level1 != "Select Level...")&& ($course1 != "Select Course...")&& ($dept1 != "Select Department..."))
		{
			$_SESSION['student_dept'] = $dept =$_POST['dept2'];
			$_SESSION['student_course']= $course =$_POST['course2'];
			$_SESSION['student_level'] = $level =$_POST['level'];
			$_SESSION['statement'] = "All The ".$_SESSION['student_level']." Level Students in ".$_SESSION['student_course']. ".";
...
<form role="form" class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data" method="POST" name="step2">
								...
								<div class="form-group">
									<div class=" col-lg-offset-3 col-lg-3">
											<button type="submit" name="submit2" class="btn btn-success">Click to Back </button>
									</div>
									<div class=" col-lg-offset-3 col-lg-3">
