	...
	<div class="row">
        <div class="col-xs-12 col-sm-12">
			...
			<div  class="col-sm-10 col-md-10 col-lg-10">
				   ...
				   style="color:yellow; font-weight:bold; font-family:'Times New Roman', Times, serif; font-size:20px;"> All MY PUBLICATIONS : <?php echo $publication_count; ?></center>
...
<form role="form" class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data" method="POST" name="step2">
							<table class="table table-condensed" style="background-color:#FFFFFF;">
												...
												<tbody>
													...
													$box_type="Draft";
													$sql    = "SELECT count(*) FROM file_server where publisher_mail = '".$_SESSION['username']."'";
													...
													$status="";
													$sql = "SELECT * FROM file_server where publisher_mail= '".$_SESSION['username']."' ORDER BY id DESC LIMIT {$per_page} OFFSET {$offset} "; 
													$retval = mysql_query($sql, $conn);
													if (!$retval) {
														die('Could not get data: ' . mysql_error());
													}
