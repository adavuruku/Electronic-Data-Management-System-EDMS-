...
$f="Out";
$sql = "Select id,mail_id,sender_name,sender_dept,sender_address,receiver_name,receiver_dept,receiver_address,message_type,subject,body,date_sent,box_type,attached_status from $DB_TBLName where box_type !='".$f."' ORDER BY ID DESC";
