...
$query2 = "SELECT * FROM draft_mail where username =:username AND draft_id=:draft_id";
$stmt2 = $conn->prepare($query2);
$stmt2->bindValue(':username',$_SESSION['username'], PDO::PARAM_STR);
$stmt2->bindValue(':draft_id',$d, PDO::PARAM_STR);
$stmt2->execute();
$rows3 = $stmt2->fetch(PDO::FETCH_ASSOC);
$row_count2 = $stmt2->rowCount();
if($row_count2 >= 1) 
{
	$date=$rows3['date_save'];
	...
	$_SESSION['resend_id'] = $rows3['draft_id'];
