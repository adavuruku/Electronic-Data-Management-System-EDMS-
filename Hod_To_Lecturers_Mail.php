...
{
	$_SESSION['lecturer_course'] = $lecturer_course = $_POST['course'];
	$_SESSION['statement'] = "All The ".$_SESSION['lecturer']." in ".$lecturer_course;
	if ($lecturer_course=="All")
	{
		$_SESSION['statement'] = "All The ".$_SESSION['lecturer']." in ".$_SESSION['department']. " Department";
	}
...
<form role="form" class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data" method="POST" name="step2">
								...
								<p> <?php echo $_SESSION['username']; ?> , You have sellect a <span style="color:red"><?php echo $_SESSION['group_type'];?> </span> Mail Type.</p>
											<p>Please Select Course of the <span style="color:red"><?php echo $_SESSION['group_type'];?> </span> to Receive your Group mail.</p>
										<hr>
								</div>
													 <div class="form-group">
														<label for="course2" class="control-label col-xs-3">Select Course :<span style="color:red"class"require">*</span></label>
														<div class="col-xs-5">
															<div class="input-group">
																<span class="input-group-addon"><span class="glyphicon glyphicon-pencil"></span></span>
																<select class="form-control" id="course" name="course">
																<!--<option value="<?php// echo $_SESSION['department']." Department"?>" ><?php //echo "All ".$_SESSION['lecturer']?></option>-->
																	...
																	<?php
																			...
																			if ($stmt->rowCount () > 1)
																			{
																				echo '<option value="All" >All '.$_SESSION['lecturer'].'</option>';
